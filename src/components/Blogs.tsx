    ...
    <section className="flex flex-col">
            ...
            return (
              <div className="flex flex-col gap-6" key={index}>
                ...
                <div className="flex flex-col gap-4">
                  <h3 className="text-[#3C403A] text-[0.875rem]">
                    {item.heading}
                  </h3>
                  <h5 className="text-[#141513] text-[1.3rem] font-bold leading-[142%]">
                    {item.title}
                  </h5>
                </div>
              </div>
      ...
      <div className="xs:p-6 md:p-10 lg:p-20 bg-[#EFF0EF] flex xs:flex-col lg:flex-row gap-10">
        ...
        <div className="basis-full flex justify-end">
          <div className="xs:w-full lg:w-fit xs:h-fit sm:h-[21rem] lg:h-fit relative p-5 border border-lightgrey rounded-4xl flex">
            <img
              className="w-full h-full rounded-3xl aspect-auto"
              src={Thumbnail}
              alt="Datawise thumbnail image"
            />
            <div className="absolute bottom-0 left-0 flex items-center gap-3 w-[70%] p-5 rounded-3xl bg-white border border-lightgrey">
              <svg
                width="19"
                height="18"
                viewBox="0 0 19 18"
              ...
              <div className="flex flex-col gap-2.5 w-full">
                <div className="h-[12px] w-1/2 bg-[#E0E2DE] rounded-2xl"></div>
                <div className="h-[12px] w-full bg-[#E0E2DE] rounded-2xl"></div>
              </div>
            </div>
          </div>
        </div>
